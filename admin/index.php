      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php echo number_format($total_recipes) ?></h6>
            ...
            $stmt = $conn->prepare("SELECT * FROM `logs` ORDER BY `id` ASC");
            $stmt->execute();
            $result = $stmt->get_result();
            while ($row = $result->fetch_assoc()) {
            $array_logs[] = $row;
            }
            $numberlogs = sizeof($array_logs);
            for ($i=0; $i < $numberlogs; $i++) { 
              $count = $i + 1;
            ?>                      
                      <tr>
                        <th scope="row"><?php echo $count; ?></a></th>
                        <td><?php echo $array_logs[$i]['ip_address']; ?></td>
                        <td><?php echo $array_logs[$i]['date_time']; ?></td>
                        <td><?php echo $array_logs[$i]['description']; ?></td>
                      </tr>
            <?php } ?>
