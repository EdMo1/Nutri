...
if(isset($_POST['save'])){
  include("includes/dbconn.php");
        ...
        //$email = $_POST['email'];
        $idd = 1;
        $stmt = $conn->prepare("UPDATE `tblusers` SET `name` = ? WHERE `email` = ?");
        $stmt->bind_param("ss",$name,$em);
        $stmt->execute();
...
if(isset($_POST['change'])){
  include("includes/dbconn.php");
        ...
        $stmt = $conn->prepare("SELECT `password`FROM `tblusers` WHERE `email` = ?");
        $stmt->bind_param("s", $em);
        $stmt->execute();
        $stmt->store_result();
        ...
        if ($fpass == $passc) {   
          ...
          if ($passn == $passr) {  
            ...
            //$idd = 1;
            $stmt = $conn->prepare("UPDATE `tblusers` SET `password` = ? WHERE `email` = ?");
            $stmt->bind_param("ss",$passn,$em);
            $stmt->execute();
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane  active profile-edit pt-3" id="profile-edit">
                  ...
                  <form enctype='multipart/form-data' method="POST" action="" >
                    ...
                    <div class="row mb-3">
                      <label for="Email" class="col-md-4 col-lg-3 col-form-label">Age</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="age" type="number" class="form-control" id="Email" value="<?php echo $age; ?>"  >
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="Email" class="col-md-4 col-lg-3 col-form-label">Height (cm)</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="height" type="number"  class="form-control" id="Email" value="<?php echo $height; ?>" >
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Email" class="col-md-4 col-lg-3 col-form-label">Weight (kg)</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="weight" type="number" class="form-control" id="Email" value="<?php echo $weight; ?>" >
                      </div>
                    </div>
